...
var trackingCode = function(){
  ...
  url = 'https://eaa6c45fbbd6.ngrok.io/app.html?shop=' + (window.Shopify && window.Shopify.shop) + '&referrer=' + getReferrer() + '&parentDomain=' + window.location.host + '&clientId=' + 'child_site_2';
